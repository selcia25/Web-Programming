...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { age: @resume.age, name: @resume.name, phone: @resume.phone, skills: @resume.skills } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { age: @resume.age, name: @resume.name, phone: @resume.phone, skills: @resume.skills } }
