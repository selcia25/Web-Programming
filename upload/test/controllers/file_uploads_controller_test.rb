...
class FileUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_upload" do
    assert_difference("FileUpload.count") do
      post file_uploads_url, params: { file_upload: { file: @file_upload.file, title: @file_upload.title } }
    end
  ...
  test "should update file_upload" do
    patch file_upload_url(@file_upload), params: { file_upload: { file: @file_upload.file, title: @file_upload.title } }
